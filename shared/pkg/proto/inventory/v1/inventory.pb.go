...
type Part struct {
	...
	// Price цена в копейках (например, 5000₽ = 500000)
...
// GetPartResponse ответ метода, содержащий объект Part
...
// ListPartsResponse ответ метода, содержащий список найденных деталей
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB@Z>github.com/mercuryqa/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
